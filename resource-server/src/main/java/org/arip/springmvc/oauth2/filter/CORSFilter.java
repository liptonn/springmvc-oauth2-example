package org.arip.springmvc.oauth2.filter;
...
/**
 * Created by Arip Hidayat on 13/03/2016.
 */
public class CORSFilter extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (allowedOrigins.contains(origin)) {
            System.out.println("Origin "+origin+" exist in clients.properties");
            ...
            System.out.println("Origin " + origin + " not exist in clients.properties");
            return true;
        }
    }
}
